...
public class MasterController implements Initializable {
    ...
    private void showSupplierMaster(ActionEvent event) {
        try {
            Parent parent=FXMLLoader.load(getClass().getResource("/satyamconsignment/ui/Master/Supplier/MasterSupplier.fxml"));
    ...
    private void showBuyerMaster(ActionEvent event) {
        try {
            Parent parent=FXMLLoader.load(getClass().getResource("/satyamconsignment/ui/Master/Buyer/MasterBuyer.fxml"));
            root.getChildren().setAll(parent);
        } catch (IOException ex) {
            rrc.showAlert(ex.toString());
            Logger.getLogger(MasterController.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void showTransportMaster(ActionEvent event) {
        try {
            Parent parent=FXMLLoader.load(getClass().getResource("/satyamconsignment/ui/Master/Transport/MasterTransport.fxml"));
            root.getChildren().setAll(parent);
        } catch (IOException ex) {
            rrc.showAlert(ex.toString());
            Logger.getLogger(MasterController.class.getName()).log(Level.SEVERE, null, ex);
