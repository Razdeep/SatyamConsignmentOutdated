...
public class PaymentHistoryController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            while(rs.next())
            {
                list.add(new Record(rs.getString("Voucher No."),rs.getString("Voucher Date"),rs.getString("Supplier Name"),rs.getString("Total Amount")));
            }
    ...
    public static class Record {
        private String voucherNo,voucherDate, supplierName, totalAmount;
